...
<head>
    ...
    <title>Alumnos Profesores y Cursos</title>
...
<body>
    <form method="post">
        ...
        <select name="opciones">
            ...
            <option value="profes"<?php if($_POST['opciones']=="profes"){echo"selected";}?>>Profesores</option>
        ...
        if(isset($_POST['opciones'])){
            try{
                ...
                if($opcion==="alumnos"){
                    ...
                    echo"</table>";
                }elseif($opcion==="profes"){
                    $profes="SELECT profesores.id_profesor, profesores.nombre, profesores.apellidos, cursos.nombre_curso 
                                    FROM profesores JOIN cursos
                                    ...
                                    */
                    $stmt=$conexion->prepare($profes);

                    $stmt->execute();
                    echo"<table border='1'>
                            <tr>
                                <th colspan='5'>Datos de los Profesores</th>
                            </tr>
                            <tr>
                                <th>ID</th>
                                <th>NOMBRE</th>
