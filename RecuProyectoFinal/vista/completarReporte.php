<html>
    ...
    <body>
        ...
        <form action="index.php?action=completarReportes" method="post" class="form-container">
            ...
            <button type="submit">Completar Reporte</button>
        </form>
    </body>
</html>